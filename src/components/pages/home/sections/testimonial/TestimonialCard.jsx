...
export default function TestimonialCard({ testimonial }) {
  return (
<div className="relative flex flex-col lg:flex-row gap-6 p-5 lg:p-8 bg-white rounded-[25px] lg:rounded-[35px] shadow-md lg:shadow-lg hover:shadow-lg lg:hover:shadow-xl transition-all duration-300 h-[450px] sm:h-[400px] lg:h-[350px] overflow-hidden group"
                ...
                >
                  ...
                  <div className="flex-shrink-0 z-10">
                    <div className="relative w-28 h-28 lg:w-40 lg:h-40 mx-auto lg:mx-0">
                      ...
                      />
                      <div 
                        className="absolute -top-3 -left-3 lg:-top-5 lg:-left-5 bg-white/90 backdrop-blur-sm p-2 lg:p-3 rounded-md lg:rounded-lg shadow-xs lg:shadow-sm"
                      >
                        <FaQuoteRight 
                  ...
                  <div className="flex flex-col justify-between flex-1 h-5 lg:h-full z-10">
                    ...
                    <div className="border-t border-stone-200 pt-3 lg:pt-5">
                      <h4 className="text-base lg:text-lg font-semibold text-stone-800">
                        {testimonial.name}
                      </h4>
                      <p className="text-stone-600 mt-1 text-xs lg:text-sm">
                        {testimonial.title}
                      </p>
                  ...
                  <div className="absolute inset-0 rounded-[25px] lg:rounded-[35px] border border-transparent group-hover:border-primary/20 transition-all duration-500 pointer-events-none"
                    style={{ clipPath: 'polygon(0 0, 100% 0, 100% 92%, 92% 100%, 0 100%)' }}
                  />
                </div>
  )
