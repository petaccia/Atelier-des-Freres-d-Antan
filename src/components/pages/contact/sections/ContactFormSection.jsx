        ...
        <div className="max-w-3xl mx-auto bg-primary-dark rounded-2xl p-6 md:p-8 shadow-xl border border-accent/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="name" className="block text-whiteGray mb-2">
                  Nom complet *
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="email" className="block text-whiteGray mb-2">
                  Email *
                </label>
                <input
                  type="email"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="phone" className="block text-whiteGray mb-2">
                  Téléphone
                </label>
                <input
                  type="tel"
              ...
              <div>
                <label htmlFor="subject" className="block text-whiteGray mb-2">
                  Sujet *
                </label>
                <select
                  id="subject"
            ...
            <div>
              <label htmlFor="message" className="block text-whiteGray mb-2">
                Message *
              </label>
              <textarea
                id="message"
              ...
              >
                ...
                <FiSend
                  className={
                    isSubmitting
                      ? "animate-pulse"
                      : "animate-[slideRight_1.5s_ease-in-out_infinite]"
                  }
                />
              </button>
            </div>
