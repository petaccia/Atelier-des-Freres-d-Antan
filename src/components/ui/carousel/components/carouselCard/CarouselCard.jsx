...
export default function CarouselCard({ slide }) {
  return (
    <div className="relative w-full h-[60vh] md:h-screen overflow-hidden">
      ...
      <div className="absolute  bottom-1/14 left-1/10  sm:left-1/5 md:bottom-[40%] md:left-1/4  bg-gray-900/70 w-[80%] sm:w-[70%] md:w-[60%] lg:w-[50%] h-[450px] md:h-[450px] rounded-2xl z-20 5 p-6 text-center" >
        <div className="max-w-xs md:max-w-xl mx-auto space-y-2 sm:space-y-4 ">
          ...
          <p className="h-24 sm:h-14 md:h-12 text-white max-w-2xl mb-12 md:my-8 text-xs">{slide.text}</p>
          <blockquote className="h-10 sm:h-10 md:h-12 text-white italic   sm:mb-8 md:my-12">{slide.quote}</blockquote>
