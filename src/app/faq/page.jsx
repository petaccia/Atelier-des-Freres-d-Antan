          ...
          <div className="max-w-4xl mx-auto mb-16 p-8 border-2 border-white/20 rounded-2xl bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-lg">
            <div className="flex items-start gap-6">
              ...
              <div className="space-y-4">
                <h2 className="text-2xl font-bold text-whiteAmber">Bienvenue sur notre page de questions fréquentes</h2>
                <p className="text-whiteGray leading-relaxed">
                  Nous avons rassemblé ici les questions les plus fréquemment posées par nos clients, 
                  que ce soit en serrurerie, ferronnerie, cordonnerie ou bourrellerie. Si vous ne trouvez 
                  pas la réponse à votre question, n'hésitez pas à nous contacter directement.
                </p>
                <div className="pt-4">
                  <Link 
                    href="/contact" 
