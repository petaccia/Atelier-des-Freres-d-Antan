    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {mode === 'edit' && (
        <div className="bg-blue-900/20 p-4 rounded-lg mb-6">
          ...
          <div className="text-center text-white/70 text-sm">
            Modifiez les informations ci-dessous puis cliquez sur "Modifier" pour enregistrer les changements.
          </div>
        </div>
      )}
      ...
      <TextInput
        ...
        disabled={mode === 'delete'}
        readOnly={mode === 'edit'}
        helpText={mode === 'edit' ? "⚠️ Le chemin URL ne peut pas être modifié pour éviter les conflits" : "Exemple: /a-propos"}
      />
