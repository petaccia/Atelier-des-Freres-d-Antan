...
export const servicesBourrellerieData = [
  {
    ...
    description:
      "Nous redonnons vie à vos sacs en cuir, qu'il s'agisse de réparations de fermetures éclair, de coutures ou de renforts.",
    img: bag_repair.src,
    href: "#bag-repair",
  },
  {
  ...
  },
  {
    ...
    description:
      "Nous offrons un entretien complet pour préserver la beauté et la durabilité de vos articles en cuir.",
  ...
  },
  {
    ...
    description:
      "Votre objet en cuir est endommagé ? Notre atelier le restaure avec soin et précision.",
