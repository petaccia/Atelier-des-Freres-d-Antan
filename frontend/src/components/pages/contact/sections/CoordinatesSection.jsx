  ...
  return (
    <section id="coordinates" className="py-16 bg-gradient-to-b from-primary to-primary-dark">
      <div className="container mx-auto px-4">
        <h2 className="text-center text-whiteAmber mb-12">Nos coordonnées</h2>
        ...
        <div className="grid grid-cols-1  lg:grid-cols-2 gap-12 items-start">
          <div className="space-y-8">
            ...
            <div className="bg-primary-dark rounded-2xl p-6 md:p-8 shadow-xl border border-accent/20">
              <SocialLinks showColors={false} iconSize={20} title="Suivez-nous" />
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div
              id="opening-hours"
              className="bg-primary-dark rounded-2xl p-6 md:p-8 shadow-xl border border-accent/20"
            >
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-whiteAmber mb-1">
                    Horaires d'ouverture
                  </h4>
                </div>
              </div>
              ...
              <p className="text-whiteGray mt-4 text-sm italic text-center">
