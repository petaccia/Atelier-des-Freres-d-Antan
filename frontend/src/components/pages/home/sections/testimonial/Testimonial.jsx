...
export default function Testimonials() {
  ...
  return (
    <section className="bg-gradient-to-b from-whiteAmber to-whiteAmber/40 py-16">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center">
          ...
          {/* Sélecteur de type de témoignages */}
          <div className="flex justify-center gap-4 mb-12">
            <button
              onClick={() => setShowGoogleReviews(false)}
        ...
        {/* Affichage conditionnel des témoignages ou des avis Google */}
        {showGoogleReviews ? (
          <div className="">
            <CustomGoogleReviews />
          </div>
